    ...
    public static String oneSwitchToRuleThemAll(int tagValueID) {
        ...
        switch (tagValueID) {
            ...
            case 31905: // Radio/KBYi
                email = "isleb@byui.edu";
                break;
            case 31906: // ROTC
                email = "hamiltonau@byui.edu";
                break;
            case 31907: // Safety & Security
                email = "publicsafety@byui.edu";
                break;
            ...
            case 31910: // Stores & Receiving
                email = "spauldingbr@byui.edu";
                break;
            case 31911: // Student Activities
                email = "activities@byui.edu";
                break;
            ...
            case 33598: // Livestock Center
                email = "gouldingr@byui.edu";
                break;
            case 31949: // Mail Services
                email = "mailservices@byui.edu";
                break;
            case 33596: // Orchard
